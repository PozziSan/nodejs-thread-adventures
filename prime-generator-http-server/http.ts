...
const server = http.createServer((req, res) => {
    ...
    if (!runInThread) {
        console.log(
            "We're blocking the main thread because like adventure, emotion, risks, and staying all night long solving issues because a single user is blocking our application worldwide!"
        );
